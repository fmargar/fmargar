...
Soy un desarrollador apasionado por construir software robusto, escalable y seguro. Actualmente colaboro con el **Ayuntamiento de Marbella** y gestiono mi propio ecosistema digital self-hosted sobre Ubuntu Pro.

---

## 🏛️ Proyectos y Experiencia
- **Ayuntamiento de Marbella**: Sistema de Gestión de Vados (Laravel 12 + React 18 + PostgreSQL).
- **Marbella Fácil (TFG)**: Plataforma Smart City & Turismo (Laravel + React + APIs).
- **Asisa**: Gestión y optimización de portales corporativos web.

---

## 🛠️ Stack Tecnológico (Mi Ecosistema)
...
- 👔 **LinkedIn:** [Fernando Máximo](https://www.linkedin.com/in/fernando-m%C3%A1ximo-mart%C3%ADnez-garc%C3%ADa-ba40b8387/)
