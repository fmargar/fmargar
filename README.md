...
Soy un desarrollador apasionado por crear software robusto y escalable. Actualmente estoy colaborando con el **Ayuntamiento de Marbella** en el desarrollo de sistemas de gestión administrativa con un stack de última generación.

---

## 🚀 Lo que estoy haciendo ahora
- 🏛️ Desarrollando el **Sistema de Gestión de Vados** con Laravel 12, React 18 e Inertia.js.
- 🗺️ Implementando soluciones de **geolocalización** y normalización de datos legacy.
- 🎓 Finalizando mi TFG: **Marbella Fácil**, una plataforma Smart City & Turismo.
- ☁️ Certificándome en **AWS** y **Ciberseguridad**.
